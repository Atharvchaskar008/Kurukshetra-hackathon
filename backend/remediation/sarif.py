...
Transforms DepScan security findings into standard SARIF (Static Analysis Results Interchange Format)
...
def _map_severity_to_sarif_level(severity: str) -> str:
    """Map DepScan severity tier to SARIF level (error, warning, note, none)."""
